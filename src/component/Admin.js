...
class Admin extends Component {
  ...
  componentDidMount() {
    ...
    if (match) {
      ...
      axios({
      method: 'GET',
      url :`https://61bc10c0d8542f001782452f.mockapi.io/product_CRUD/${id}`,
      data : null
     }).then(res =>{
      var data =res.data;
        this.setState({
    ...
    axios.get('https://61bc10c0d8542f001782452f.mockapi.io/product_CRUD').then(res => {
  ...
  onSave = (event) => {
    ...
    if (this.state.id ===''){
      if(this.state.name !== '' && this.state.price!=='' && this.state.quantity !== '' && this.state.image!==''){
        axios({
          method:'POST',
          url :`https://61bc10c0d8542f001782452f.mockapi.io/product_CRUD`,
          data: {
      ...
      axios({
        method:'PUT',
        url :`https://61bc10c0d8542f001782452f.mockapi.io/product_CRUD/${this.state.id}`,
        data: {
          name: this.state.name,
          price: this.state.price,
          oldPrice : this.state.oldPrice,
